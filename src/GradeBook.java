public class GradeBook
{
     ...
     {
          outputGrades();
          System.out.printf(" %n Class average is  %.2f%n Highest Grade is %d%n The lowest grade is %d%n", getAverage(), getMaximum(), getMinimum());
          outputBarChart();
     }
     ...
     {
          System.out.printf("Th grades are: %n %n");
